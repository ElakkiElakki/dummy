# Booking.com Airport Taxis BDD Framework

Java Selenium BDD framework for Booking.com Airport Taxis flows using Maven, Cucumber, TestNG, Apache POI, and WebDriverManager.
...
- Airport Taxis is opened from Booking.com home page navigation, never by direct taxi URL
- Test data is driven from `src/test/resources/testdata/airport_taxi_testdata.xlsx`
...
```bash
mvn test -Dbooking.email=you@example.com -Dbrowser=chrome -Dheadless=false
```
